...
window.onload = function() {
	const defCards = ['abstract', 'quotes', 'concept', 'character', 'not_commonsense', 'skill', 'structure', 'general'];
	...
	const app = createApp({
		setup() {
			...
			const handleResetDefault = async () => {
				if (Zotero.ZotCard.Utils.confirm(_l10n.formatValueSync('zotcard-reset-default'))) {
					var template;
